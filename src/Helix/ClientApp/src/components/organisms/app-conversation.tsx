...
import ConversationMessages, {
  type Message,
} from "../molecules/conversation-messages"
  ...
  const sampleMessages: Message[] = [
    {
      ...
      type: "user",
      message:
        "Hello! Can you help me understand how to use the Anthropic API?",
    ...
    },
    {
      ...
      type: "agent",
      message:
        "Of course! I'd be happy to help you understand the Anthropic API. The API allows you to integrate Claude into your applications. What specific aspect would you like to know more about?",
    ...
    },
    {
      ...
      type: "agent",
      message:
        "For streaming responses, you can use the stream parameter. This allows you to receive the response incrementally as it's generated, which is great for real-time applications and better user experience.",
    ...
    },
    {
      ...
      type: "agent",
      message:
        "Rate limits depend on your plan tier. Generally, they're measured in requests per minute (RPM) and tokens per minute (TPM). You can check your specific limits in the Anthropic Console dashboard. The API will return a 429 status code if you exceed your limits.",
